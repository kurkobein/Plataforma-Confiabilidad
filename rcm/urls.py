...
urlpatterns = [
    ...
    path(
        'servicios/<int:pk>/fmeca/carga-masiva/columnas/',
        views.service_rcm_excel_field_preview,
        name='service_fmeca_excel_field_preview',
    ),
    ...
    path('servicios/<int:pk>/fmeca/nuevo-masivo/', views.service_fmeca_bulk_new, name='service_fmeca_bulk_new'),
