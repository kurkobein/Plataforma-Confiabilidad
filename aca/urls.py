...
urlpatterns = [
    ...
    path('servicios/<int:pk>/aca/carga-masiva/plantilla/', views.service_aca_excel_template, name='service_aca_excel_template'),
    path('servicios/<int:pk>/aca/nuevo-masivo/', views.service_aca_bulk_new, name='service_aca_bulk_new'),
    path('servicios/<int:pk>/aca/dimensiones/orden/', views.service_aca_bulk_dimension_order, name='service_aca_bulk_dimension_order'),
    path('servicios/<int:pk>/aca/grupo/<int:carga_pk>/editar/', views.service_aca_bulk_group_edit, name='service_aca_bulk_group_edit'),
    path('servicios/<int:pk>/aca/grupo/<int:carga_pk>/eliminar/', views.service_aca_bulk_group_delete, name='service_aca_bulk_group_delete'),
